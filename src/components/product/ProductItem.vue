  ...
  <div class="section-fluid-main">
    <div class="section">
      <div class="info-wrap mob-margin">
        <p class="title-up">Product Name</p>
        ...
        <v-rating
          ...
          color="yellow"
          length="5"
          :value="showProduct.rating && showProduct.rating.rate"
        ></v-rating>
        <div class="title-up">
          Ratin {{ showProduct.rating && showProduct.rating.rate }} From 5 ,Total
          Votes {{ showProduct.rating && showProduct.rating.count }}
        </div>
        <br />
...
export default {
  ...
  created() {
    this.$store
      .dispatch("productItem", { id: this.$route.params.id })
      .then((resp) => {
        this.showProduct = resp.data;
      });
  },
};
</script>
